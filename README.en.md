...
Support for Harness `0.1.2-alpha.1` is still being planned; see the
[upgrade analysis](dsh-tui-grok-升级到harness-0.1.2-alpha.1分析.md) (Chinese).

The npm path above is a tested version combination. A successful launch should not be
read as compatibility with every future DeepSeek Harness release.
