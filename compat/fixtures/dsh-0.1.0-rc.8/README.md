# DSH 0.1.0-rc.8 compatibility fixture
...
package to `0.1.0-rc.8`, and never relies on the root alpha checkout overrides.
...
`dsh-pager-grok-apiproxy-v1-rc8-e2e` profile and retains the home. Each created
