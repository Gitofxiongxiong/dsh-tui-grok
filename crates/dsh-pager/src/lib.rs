...
pub use loader::{
    ...
    interrupt_subagent, list_agent_presets, list_file_references, list_sessions, list_subagents,
    ...
    set_session_mode, submit_prompt, submit_prompt_for_session, subscribe_control_plane,
    update_queue,
};
