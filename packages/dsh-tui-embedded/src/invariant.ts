/**
 * Package-owned invariant companion for `@dsh-pager-grok/tui-embedded`.
 * @module @dsh-pager-grok/tui-embedded/invariant
 */

import type { Context } from '@deepseek-ai/cordis'
import type { InvariantInstaller } from '@deepseek-ai/dsh-invariants'

const PACKAGE_NAME = '@dsh-pager-grok/tui-embedded'

/** Cordis companion plugin name. */
export const name = 'tui-embedded-bundle-invariant'
